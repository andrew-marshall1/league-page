...
<div class="constitution">
    <h1 class="noUnderscore">HAYNES MECHANICAL FANTASY LEAGUE CONSTITUTION</h1>
    ...
    <p>Trading of players only are allowed. This is a redraft league, so pick trading is not applicable. Trades will process immediately and will be reversed if vetoed or under investigation for collusion.</p>
    ...
    <div class="subBlock">
        ...
        <ul>
            <li>First Offense – Immediate reversal of the trade and freeze on all transaction types for the next 6 weeks of the regular season and playoff fantasy football games, including trades and waiver wire bids</li>
            <li>Second Offense – Immediate freeze on all transaction types for the next 12 weeks of regular season and playoff fantasy football games, including trades and waiver wire bids</li>
            <li>Third Offense – Third Offense – A league meeting of all members not involved in any of the improper trades/activity in question will take place to discuss next steps.</li>
        </ul>
    ...
    <div class="subBlock">
        <p>The trade deadline will be set for the end of the Monday night game of the week 11 games of the NFL season.</p>
    </div>
    ...
    <p>Reverse Standings waiver wire system. Bids will process Wednesday at 1 AM. Players are on waivers for 1 day after being dropped.</p>
    ...
    <p>The draft order each year will be randomly selected. The draft itself will be a snake draft.</p>

        
    <h2 class="sectionHeading" bind:this={three}>Section 3 Scoring System</h2>

    <h3 bind:this={threeOne}>3.1 Scoring System</h3>
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app (for the most part, it follows typical 1 PPR scoring).

<p>The league will follow all official NFL statistics to determine winners, tiebreakers, etc. This will be the standard metric moving forward. The commissioner reserves the right to have the deciding call in any abnormal circumstances.</p>
    
    <h2 class="sectionHeading" bind:this={four}>Section 4 Postseason</h2>
    
    <h3 bind:this={fourOne}>4.1 Playoffs</h3>
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 15. The top 6 teams that finish with the best records, will receive a playoff berth, with the top two teams wit h the best record will receive a bye week. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    ...
    <p>No team may intentionally leave starting roster spots empty. Any evidence of intentionally leaving roster spots empty in order to improve another team's situation may be subject to punishment, including but not limited to potential expulsion from the league.</p>
    ...
    <p>When a manager needs to be replaced, the commisioner will try to find a suitable candidate with some connection to Haynes and at least a portion of the existing managers. Priority will be placed on managers who have fantasy football experience and will be very active within the league.</p>
    
    
    <h2 class="sectionHeading" bind:this={seven}>Section 7 League Finances</h2>
    
    <h3 bind:this={sevenOne}>7.1 League Dues</h3>
    <p>League dues are set at ${dues}. Dues are collected through <a href="https://www.venmo.com/u/Andy-Marshall-17">Venmo</a> and collection will be sent out prior to the date of the draft. All managers must be fully paid up before the start of the draft. In the event that a manager fails to pay before the deadline, a 10% penalty will be addd to their payment and will go towards the payouts at the end of the year and the commisioner reserves the right to select the first pick for the offending manager.</p>
    ...
    <p>The winner of the Ted Gregory Award for Last Place will be responsible for providing $100 worth of food & drinks at next years draft. If the manager is unable to make the draft in person, they will provide the $100 to the commisioner, so he has the ability to pay at the next draft.
    
    <h3 bind:this={sevenThree}>7.3 Raising Dues</h3>
    <p>A ⅔ majority vote is required in order to raise league dues. In the event that a manager is no longer financially comfortable with the buyin, finding a co-manager to split the cost is acceptable.</p>
