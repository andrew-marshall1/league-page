...
<div class="constitution">
    <h1 class="noUnderscore">DYNASTY CONSTITUTION</h1>
    ...
    <p>6 regular bench spots (2 Taxi spots for rookies only - will lock at the start of Week 1)</p>
    ...
    <div class="subBlock">
        <p>You will not be able to trade draft picks that are more than 3 drafts away. For example, during the 2023 season you cannot trade any picks in or after the 2027 draft.</p>
    </div>
    
    <h4 bind:this={oneTwoFive}>1.2.5 Veto/Trade Process</h4>
    <div class="subBlock">
        <p>Vetoes are only appropriate in instances of collusion or an egregious mismatch of value (i.e. CMC for a backup kicker). Not liking a trade does not warrant a veto. If the commisioner feels a veto could be in order, he reserves the right to have the league vote on the trade. In that case, 7 veto votes would be required to void the trade.</p>
    </div>
    ...
    <p>The draft order each year will be a linear draft in reverse order of the previous year’s regular season and playoff standings.</p>

    <h3 bind:this={twoTwo}>2.2 Rookie Drafts</h3>
    <p>Rookie drafts will consist of 3 round of drafting, with 1.5 minutes alotted for each pick. Free agency will open immediately after the draft, at which point you will need to have cut the necessary players in order to make any roster changes.</p>
